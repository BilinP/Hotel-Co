...
public class FXMLPaths {
    ...
    public static final String MENU = "/com/hotelco/views/MenuGUI.fxml";
    public static final String ORDER_LOOKUP = "/com/hotelco/views/ReservationHistoryGUI.fxml";
    ...
    public static final String NEWMENU=  "/com/hotelco/views/NEWMenuGUI.fxml";
